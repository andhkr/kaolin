...
class SimplicitsObject:
    def __init__(self, pts, yms, prs, rhos, appx_vol, num_handles=10, num_samples=1000, model_layers=6,
                 training_batch_size=10, normalize_for_training=True, warp_training=False,skining_method='lbs'):
        ...
        Args:
            ...
            skining_method:which method use for skining lbs , dual quaternion or what.
        """
